...
public class MainActivity extends Activity {
    ...
    void stopServer(){stopRequested=true;resetPeer();status.setText("Статус: остановлен");log.setText("Сервер остановлен");stopService(new Intent(this,ServerService.class));}
    void checkNetwork(){String ip=getIp();String ps2=lastPeerActivity>0?"\nPS2 активна: "+peerIp:"\nPS2: активности нет";Toast.makeText(this,ip.equals("не определён")?"Wi-Fi/LAN IP пока не определён":"Сеть OK. IP сервера: "+ip+ps2,Toast.LENGTH_LONG).show();}
}
