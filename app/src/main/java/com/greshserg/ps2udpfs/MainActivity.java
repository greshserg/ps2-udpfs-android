...
public class MainActivity extends Activity {
    ...
    EditText folder; TextView status, ps2Status, info, log; Button start, stop, check;
    ...
    void stopServer(){stopRequested=true;resetPeer();status.setText("Статус: остановка...");log.setText("Останавливаю сервер...");Intent i=new Intent(this,ServerService.class);i.setAction(ServerService.ACTION_STOP);startService(i);}
    void checkNetwork(){String ip=getIp();String ps2=lastPeerActivity>0?"\nPS2 активна: "+peerIp:"\nPS2: активности нет";Toast.makeText(this,ip.equals("не определён")?"Wi-Fi IPv4 пока не определён":"Сеть OK. Wi-Fi IP сервера: "+ip+ps2,Toast.LENGTH_LONG).show();}
}
